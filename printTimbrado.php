            ...
            <aside class="right-side strech">
                ...
                ?>
                        ...
                        <div class="col-xs-12">
                            <h2 class="page-header" style="overflow: auto;">
                                <span class="pull-left">
                                    ...
                                    <cite style="font-size: 13px;">(47)3365 9500 - www.camboriu.sc.gov.br</cite><br>
                                    <cite style="font-size: 13px;">0800 646 9500 - ouvidoria@cidadedecamboriu.sc.gov.br</cite>
                                </span>
                    ...
                    <div class="row invoice-info">
                        <div class="col-xs-12">
                            <h1 class="text-center text-uppercase"><?php echo $lin2->descricao.' - '.$lin->protocolo; ?></h1>
                        </div>
                    </div>
                ...
                <?php
                    ...
                    mysql_close($conexao);
                    unset($conexao,$charset,$sql,$res,$ret,$py,$sql2,$res2,$ret2,$lin2,$sql3,$res3,$ret3,$lin3,$sql4,$res4,$ret4,$lin4,$sql5,$res5,$ret5,$lin5,$sql6,$res6,$ret6,$lin6,$dia,$mes,$ano,$py);
                ?>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
       ...
       <!-- jQuery 2.0.2 -->
        ...
        <script type="text/javascript">
            $(function() {
                ...
                <?php if(!empty($lin)) { ?> print(); location.href = 'timbrado.php'; <?php } unset($lin); ?>
