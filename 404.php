        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>404 Erro de p&aacute;gina</h1>
                </section>
                ...
                <section class="content">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            ...
                            <p>
                                N&oacute;s n&atilde;o encontrados a p&aacute;gina. 
                                Entretanto, voc&ecirc; pode <a href="inicio.php">ir para o in&iacute;cio</a> ou tentar fazer uma busca.
                            </p>
                        </div><!-- /.error-content -->
                    </div><!-- /.error-page -->
                </section><!-- /.content --> 
