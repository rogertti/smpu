        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Edita arquiteto/engenheiro <small><i class="fa fa-asterisk"></i> Campo obrigat&oacute;rio</small></h1>
                </section>
                ...
                <section class="content">
                    <?php
                        ...
                        $sql = "SELECT * FROM engenheiro WHERE idengenheiro = ".$_GET[''.$pyengenheiro.'']."";
                        $res = mysql_query($sql);
                    ...
                    ?>
                    <form class="edita-engenheiro">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Input addon -->
                                <div class="box box-info">
                                    <div class="box-body">
                                        <input type="hidden" id="idengenheiro" value="<?php echo $lin->idengenheiro; ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                ...
                                                <?php
                                                    if(strlen($lin->cau_crea) >= 8) {
                                                        echo'<option value="1" selected>Arquiteto</option>
                                                        <option value="2">Engenheiro</option>';
                                                    }

                                                    if(strlen($lin->cau_crea) <= 7) {
                                                        echo'<option value="1">Arquiteto</option>
                                                        <option value="2" selected>Engenheiro</option>';
                                                    }
                                                ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-4 col-lg-3">
                                                ...
                                                <?php
                                                    if(strlen($lin->cau_crea) >= 8) {
                                                ?>
                                                        <input type="text" id="cau" class="form-control" maxlength="10" value="<?php echo $lin->cau_crea; ?>" title="CAU" placeholder="CAU" required />
                                                ...
                                                <?php
                                                    ...
                                                    if(strlen($lin->cau_crea) <= 7) {
                                                ?>
                                                        <input type="text" id="cau" class="form-control hided" maxlength="10" title="CAU" placeholder="CAU" />
                                                        <input type="text" id="crea" class="form-control" maxlength="10" value="<?php echo $lin->cau_crea; ?>" title="CREA" placeholder="CREA" required />
                                                        <!--<span class="info-here-3 mode msgarq">
                                                            <a class="tt chgeng hided" title="Mudar para CREA" href="#"><i class="fa fa-exchange"></i></a>
                                                            <a class="tt chgarq" title="Mudar para CAU" href="#"><i class="fa fa-exchange"></i></a>
                                                        </span>-->
                                                <?php
                                                    }
                                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                ...
                                                <input type="text" id="telefone" class="form-control" maxlength="13" value="<?php echo $lin->telefone; ?>" title="Telefone do arquiteto/engenheiro" placeholder="Telefone" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                <span class="input-group-addon"><i class="fa fa-square-o"></i></span>
                                                <input type="text" id="celular" class="form-control" maxlength="14" value="<?php echo $lin->telefone; ?>" title="Celular do arquiteto/engenheiro" placeholder="Celular" />
                                                <input type="text" id="telefone" class="form-control hided" maxlength="13" title="Telefone do arquiteto/engenheiro" placeholder="Telefone" />
                                                <span class="info-here-4 mode msgtel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                                <input type="email" id="email" class="form-control" maxlength="100" value="<?php echo $lin->email; ?>" placeholder="E-mail" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php
                        ...
                        mysql_close($conexao);
                        unset($conexao,$charset,$sql,$res,$ret,$lin,$pyengenheiro);
                    ?> 
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
