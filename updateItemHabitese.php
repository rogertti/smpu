<?php
    ...
    if (empty($_POST['iditemhabitese'])) { echo'Vari&aacute;vel de controle nula.'; exit; }
    ...
    if ($filtro == 1) {
        ...
        $sql = "SELECT iditem_habitese FROM item_habitese WHERE descricao = '".$_POST['descricao']."' AND iditem_habitese <> ".$_POST['iditemhabitese']."";
        $res = mysql_query($sql);
        ...
        //insere no banco
        $sql = "UPDATE item_habitese SET descricao = '".$_POST['descricao']."' WHERE iditem_habitese = ".$_POST['iditemhabitese']."";
        $res = mysql_query($sql);
