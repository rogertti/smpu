        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Novo item do habite-se <small><i class="fa fa-asterisk"></i> Campo obrigat&oacute;rio</small></h1>
                </section>

                <!-- Main content -->
                <section class="content">
                    <form class="novo-item-habitese">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Input addon -->
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="descricao" rows="6" title="Descri&ccedil;&atilde;o" placeholder="Descri&ccedil;&atilde;o" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
