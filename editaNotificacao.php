        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Edita notifica&ccedil;&atilde;o <small><i class="fa fa-asterisk"></i> Campo obrigat&oacute;rio</small></h1>
                </section>
                ...
                <section class="content">
                    ...
                    ?>
                    <form class="edita-notificacao" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Input addon -->
                                <div class="box box-info">
                                    <div class="box-body">
                                        <input type="hidden" id="idfiscalizacao" value="<?php echo $lin->idfiscalizacao; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                ...
                                                <?php
                                                    ...
                                                    #$sql2 = "SELECT imovel.idimovel,imovel.inscricao FROM contribuinte,imovel,fiscalizacao WHERE fiscalizacao.imovel_idimovel = imovel.idimovel AND imovel.idimovel = ".$lin[1]."";
                                                    $sql2 = "SELECT imovel.idimovel,imovel.inscricao,imovel.endereco,imovel.apto,imovel.complemento,imovel.edificio_condominio,imovel.bairro,imovel.lote,imovel.quadra,imovel.loteamento,contribuinte.nome,contribuinte.cpf_cnpj FROM contribuinte,imovel,fiscalizacao WHERE fiscalizacao.imovel_idimovel = imovel.idimovel AND contribuinte.idcontribuinte = imovel.contribuinte_idcontribuinte AND imovel.idimovel = ".$lin->imovel_idimovel."";
                                                    ...
                                                    $ret2 = mysql_num_rows($res2);
                                                        ...
                                                        if($ret2 != 0) {
                                                            ...
                                                            <input type="text" id="imovel_notificacao" class="form-control" value="'.$lin2->inscricao.'" maxlength="18" title="Inscri&ccedil;&atilde;o do im&oacute;vel" placeholder="Inscri&ccedil;&atilde;o" required />';
                                                        }
                                                        else {
                                                            $disabled = 'true';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                                <input type="text" id="notificacao" class="form-control" value="<?php echo $lin->notificacao; ?>" maxlength="9" value="" title="N&uacute;mero da notifica&ccedil;&atilde;o" placeholder="Notifica&ccedil;&atilde;o" required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php
                                                    ...
                                                    $sql2 = "SELECT idfuncionario,nome FROM funcionario WHERE idfuncionario = ".$lin->funcionario_idfuncionario."";
                                                    $res2 = mysql_query($sql2);
                                                    $ret2 = mysql_num_rows($res2);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-3">
                                                <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                                <input type="text" id="data_notificacao" class="form-control" maxlength="10" value="<?php echo $lin->datado; ?>" title="Data de entrada" placeholder="Data" required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Hora</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-6">
                                                ...
                                                <?php
                                                    if($lin->responsavel == 'Anderson Piemotez') { echo'<option value="Anderson Piemotez" selected>Anderson Piemotez</option>'; } else { echo'<option value="Anderson Piemotez">Anderson Piemotez</option>'; }
                                                    if($lin->responsavel == 'Mauricio Viana da Silva') { echo'<option value="Mauricio Viana da Silva" selected>Mauricio Viana da Silva</option>'; } else { echo'<option value="Mauricio Viana da Silva">Mauricio Viana da Silva</option>'; }
                                                    if($lin->responsavel == 'Ricardo Alexandre Aragão') { echo'<option value="Ricardo Alexandre Arag&atilde;o" selected>Ricardo Alexandre Arag&atilde;o</option>'; } else { echo'<option value="Ricardo Alexandre Arag&atilde;o">Ricardo Alexandre Arag&atilde;o</option>'; }
                                                ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="receptor" class="form-control" value="<?php echo $lin->receptor; ?>" maxlength="255" title="Nome do receptor da notifica&ccedil;&atilde;o" placeholder="Receptor" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-square-o"></i></span>
                                                <textarea class="form-control" id="situacao" rows="6" title="Situa&ccedil;&atilde;o da obra" placeholder="Situa&ccedil;&atilde;o"><?php echo $lin->situacao; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Medidas</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-square-o"></i></span>
                                                <textarea class="form-control" id="medida" rows="6" title="Medidas &agrave; serem tomadas" placeholder="Medidas"><?php echo $lin->medida; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Prazo</label>
                                            <div class="input-group col-md-6 col-lg-3">
                                                ...
                                                <?php
                                                    for($i = 1;$i <= 30;$i++) {
                                                        if($lin->prazo == $i) {
                                                            if($i == 1) {
                                                                echo'<option value="'.$i.'" selected>'.$i.' dia</option>';
                                                            }
                                                            else {
                                                                echo'<option value="'.$i.'" selected>'.$i.' dias</option>';
                                                            }
                                                        }
                                                        else {
                                                            if($i == 1) {
                                                    ...
                                                    <div class="form-group"><i class="fa fa-asterisk"></i> <label for="motivo">Grau m&iacute;nimo</label></div>
                                                        <table class="table">';
                                                            ...
                                                            while($lin2 = mysql_fetch_object($res2)) {
                                                                ...
                                                                $sql3 = "SELECT infracao_idinfracao FROM fiscalizacao_has_infracao WHERE fiscalizacao_idfiscalizacao = ".$lin->idfiscalizacao." AND infracao_idinfracao = ".$lin2->idinfracao."";
                                                                $res3 = mysql_query($sql3);
                                                                $ret3 = mysql_num_rows($res3);
                                                                    
                                                                    if($ret3 != 0) {
                                                                        echo'<tr><td><input type="checkbox" name="motivo[]" value="'.$lin2->idinfracao.'" checked disabled></td> <td><a id="del-'.$lin2->idinfracao.'-'.$lin->idfiscalizacao.'" class="delifr tt" title="Desmarcar essa infra&ccedil;&atilde;o" href="#"><i class="fa fa-trash-o"></i></a> '.$lin2->descricao.'</td></tr>';
                                                                        $motivo = 1;
                                                                    }
                                                                    else {
                    ...
                    <?php
                        ...
                        mysql_close($conexao);
                        unset($conexao,$charset,$sql,$res,$ret,$lin,$pyfiscalizacao,$motivo);
                    ?> 
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
