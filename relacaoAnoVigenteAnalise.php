                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body table-responsive">
                                    <?php
                                        ...
                                        $sql = "SELECT idanalise,protocolo_idprotocolo,situacao,responsavel,art_rrt,arquitetonico,hidrosanitario,parecer,monitor,autentico,ultimo_usuario,datado FROM analise WHERE datado >= '".date('Y-01-01')."' AND monitor = 'O' ORDER BY idanalise,situacao DESC";
                                        $res = mysql_query($sql);
