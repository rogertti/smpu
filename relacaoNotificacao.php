                                ...
                                <?php
                                    ...
                                    <div class="div-time">
                                        <div class="div-time-left text-center">
                                            <a class="lead" href="relacaoNotificacao.php?'.$getmes.'='.$mesleft.'&'.$getano.'='.$ano.'&left=1" title="M&ecirc;s anterior">
                                        ...
                                        <div class="div-time-right text-center">
                                            <a class="lead" href="relacaoNotificacao.php?'.$getmes.'='.$mesright.'&'.$getano.'='.$ano.'&right=1" title="Pr&oacute;ximo m&ecirc;s">
                                    ...
                                    #$sql = "SELECT idfiscalizacao,imovel_idimovel,funcionario_idfuncionario,notificacao,datado,hora,medida,prazo,responsavel,situacao,receptor,album,monitor,autentico,ultimo_usuario FROM fiscalizacao WHERE monitor = 'O' OR monitor = 'V' ORDER BY idfiscalizacao,notificacao,datado DESC";
                                    $sql = "SELECT idfiscalizacao,imovel_idimovel,funcionario_idfuncionario,notificacao,datado,hora,medida,prazo,responsavel,situacao,receptor,album,monitor,autentico,ultimo_usuario FROM fiscalizacao WHERE datado LIKE '".$ano."-".$mes."%' AND (monitor = 'O' OR monitor = 'V') ORDER BY idfiscalizacao,notificacao,datado DESC";
                                    $res = mysql_query($sql);
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $(".date-pick").datepicker({
                    ...
                    location.href = "relacaoNotificacao.php?<?php echo $getmes; ?>=" + dt[0] + "&<?php echo $getano; ?>=" + dt[1] + "&pick=1";
                });
