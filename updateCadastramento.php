<?php
    ...
    if (empty($_POST['idcadastramento'])) { echo'Vari&aacute;vel de controle nula.'; exit; }
    ...
    if ($filtro == 5) {
        ...
        /*$sql = "SELECT protocolo_idprotocolo FROM cadastramento WHERE protocolo_idprotocolo = '".$_POST['idprotocolo']."'";
        $res = mysql_query($sql);
        ...
        $sql = "UPDATE cadastramento SET protocolo_idprotocolo = ".$_POST['idprotocolo'].",alvara = '".$_POST['alvara']."',data_alvara = '".$_POST['data_alvara']."',habitese = '".$_POST['habitese']."',data_habitese = '".$_POST['data_habitese']."',parecer = '".$_POST['parecer']."' WHERE idcadastramento = ".$_POST['idcadastramento']."";
        $res = mysql_query($sql);
        ...
        mysql_close($conexao);
        unset($conexao,$charset,$sql,$res,$ret,$filtro,$msgnull,$sql2,$res2,$ret2,$lin,$pycadastramento,$sql3,$lin2,$res3);
    }
    else {
