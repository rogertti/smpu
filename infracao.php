        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Infra&ccedil;&otilde;es <span class="pull-right"><small><a class="lead" href="novaInfracao.php">Nova infra&ccedil;&atilde;o</a></small></span></h1>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-info">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM infracao WHERE monitor = 'O' ORDER BY nivel,descricao,valor";
                                    $res = mysql_query($sql);
                                    $ret = mysql_num_rows($res);
                                        ...
                                        if($ret != 0) {
                                                ...
                                                <tbody>';
                                                    ...
                                                    while($lin = mysql_fetch_object($res)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>R$ '.$lin->valor.'</td>
                                                            <td>
                                                                <a class="tt" title="Editar os dados da infra&ccedil;&atilde;o" href="editaInfracao.php?'.$pyinfracao.'='.$lin->idinfracao.'"><i class="fa fa-pencil"></i></a>
                                                                <a class="delifrgr tt" id="del-'.$lin->idinfracao.'" title="Excluir a infra&ccedil;&atilde;o" href="#"><i class="fa fa-trash-o"></i></a>
                                                            </td>
                                                        </tr>';
                                                    }
                                            ...
                                            <div class="alert alert-info alert-dismissable" style="display: block;">
                                                ...
                                                <b>Aviso!</b> As infra&ccedil;&otilde;es abertas recentemente ser&atilde;o listadas aqui.
                                            </div>';    
                                        }
