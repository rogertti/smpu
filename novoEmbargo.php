        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Novo embargo <small><i class="fa fa-asterisk"></i> Campo obrigat&oacute;rio</small></h1>
                </section>
                ...
                <section class="content">
                    ...
                    ?>
                    <form class="novo-embargo" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Input addon -->
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                ...
                                                <input type="hidden" id="idfiscalizacao" value="<?php echo $lin->idfiscalizacao; ?>">
                                                <input type="text" id="fiscalizacao_embargo" class="form-control" value="<?php echo $lin->notificacao; ?>" maxlength="18" title="N&uacute;mero da fiscaliza&ccedil;&atilde;o" placeholder="Fiscaliza&ccedil;&atilde;o" disabled />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php
                                                    ...
                                                    $sql3 = "SELECT idfuncionario,nome FROM funcionario WHERE idfuncionario = ".$lin->funcionario_idfuncionario."";
                                                    $res3 = mysql_query($sql3);
                                                    $ret3 = mysql_num_rows($res3);

                                                        if($ret3 != 0) {
                                                            $lin3 = mysql_fetch_object($res3);
                                                            echo'<input type="text" id="funcionario" class="form-control" value="'.$lin3->nome.'" title="Funcion&aacute;rio" placeholder="Funcion&aacute;rio" disabled />';
                                                        }
                                                        else {
                                                            $disabled = 'true';
                                                            echo'<span class="help-block">N&atilde;o &eacute; poss&iacute;vel continuar.</span>';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-3">
                                                <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                                <input type="text" id="data_embargo" class="form-control" maxlength="10" title="Data de entrada" placeholder="Data" required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Hora</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="fase" class="form-control" maxlength="255" title="Fase em que se encontra a obra" placeholder="Fase" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                ...
                                                <select class="form-control" id="situacao" title="Situa&ccedil;&atilde;o" required>
                                                    <option value="Desembargada">Desembargada</option>
                                                    <option value="Embargada" selected>Embargada</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-6 col-lg-4">
                                                <span class="input-group-addon"><i class="fa fa-square-o"></i></span>
                                                <input type="text" id="codigo" class="form-control" maxlength="20" title="N&uacute;mero do embargo" placeholder="N&uacute;mero do embargo" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Valor</label>
                                            <div class="input-group col-md-4 col-lg-3">
                                                <span class="input-group-addon"><i class="fa fa-square-o"></i></span>
                                                <input type="text" id="valor" class="form-control" maxlength="10" title="Valor da multa" placeholder="Valor" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <table class="table">';
                                                            ...
                                                            while($lin2 = mysql_fetch_object($res2)) {
                                                                ...
                                                                $ret3 = mysql_num_rows($res3);
                                                                    ...
                                                                    if($ret3 != 0) {
                                                                        echo'<tr><td><input type="checkbox" name="motivo[]" value="'.$lin2->idinfracao.'" checked disabled></td> <td><a id="del-'.$lin2->idinfracao.'-'.$lin->idfiscalizacao.'-1" class="delnebr tt" title="Desmarcar essa infra&ccedil;&atilde;o" href="#"><i class="fa fa-trash-o"></i></a> '.$lin2->descricao.'</td></tr>';
                                                                        $motivo = 1;
                                                                    }
                                                                    else {
