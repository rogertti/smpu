<?php
    ...
    if($filtro == 3) {
        ...
        //atualiza no banco
        $sql = "INSERT INTO embargo (fiscalizacao_idfiscalizacao,datado,hora,fase,valor,situacao,monitor,codigo) VALUES (".$_POST['idfiscalizacao'].",'".$_POST['datado']."','".$_POST['hora']."','".$_POST['fase']."','".$_POST['valor']."','".$_POST['situacao']."','O','".$_POST['codigo']."')";
        $res = mysql_query($sql);
