<?php require_once('config.php'); if (empty($_SESSION['key'])) { header('location:./'); } ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
                                        ...
                                        <div class="input-group"> 
                                            <?php
                                                if(base64_decode($_SESSION['type']) == 'ADM') {
                                                    if($lin->tipo == 'ADM') {
                                                        echo'<span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                                        <span class="radio-inline"><input type="radio" name="tipo" value="ADM" title="N&iacute;vel de acesso" checked> Administrador</span>
