<?php
    ...
    if ($filtro == 5) {
        ...
        $sql = "SELECT matricula FROM funcionario WHERE matricula = '".$_POST['matricula']."'";
        $res = mysql_query($sql);
        ...
        $sql = "INSERT INTO funcionario (nome,matricula,usuario,senha,email,tipo,monitor) VALUES ('".$_POST['nome']."','".$_POST['matricula']."','".$_POST['usuario']."','".$_POST['senha']."','".$_POST['email']."','".$_POST['tipo']."','O')";
        $res = mysql_query($sql);
